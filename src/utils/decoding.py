...
def get_audio_start_end_tokens(tokens: torch.Tensor, start_audio_token_id: Optional[int], end_audio_token_id: Optional[int]):
    ...
    assert start < end, f"Start of audio must be before end. Found: start - {start}, end - {end}"
